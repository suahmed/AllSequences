...
public class GraphTraversals<Value> {
  ...
  */
  ...
  public static void testSampleGraph2() {
	    ...
	    Node<String> A = new Node<String>("2");
	    Node<String> B = new Node<String>("3");
	    Node<String> C = new Node<String>("4");
	    Node<String> D = new Node<String>("5");
	    Node<String> E = new Node<String>("6");
	    Node<String> F = new Node<String>("7");
	    Node<String> G = new Node<String>("8");
	    Node<String> H = new Node<String>("10");
	    Node<String> T = new Node<String>("9");
	    ...
	    GraphTraversals<String> graph=new GraphTraversals<String>(S,T);
